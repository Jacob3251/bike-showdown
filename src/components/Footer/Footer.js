...
const Footer = () => {
  return (
    <footer className="bottom-0 bg-green-400 flex justify-center px-12 py-8 md:justify-between">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className=" flex max-w-xs mx-auto items-center justify-between">
          ...
          <a
            target={"_blank"}
            href="https://twitter.com/real_hnayeem98"
            className="text-white hover:text-black transition-colors duration-200"
          >
            <svg
              width="20"
        ...
        <div className="text-center text-white pt-10 sm:pt-12 font-light flex items-center justify-center">
          All Rights Reserved By &copy; BikeShowDown | 2022-
        </div>
      </div>
    </footer>
  );
